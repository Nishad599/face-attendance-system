...
importlib.reload(anti_spoofing)
from anti_spoofing import anti_spoof_checker

anti_spoof_checker.scale = 4.0
...
if faces:
    ...
    input_tensor = anti_spoof_checker._preprocess(bgr_image, bbox_xywh)
    ...
    print("Scale 4.0 Raw Logits:", logits)
    print("Scale 4.0 Raw Probs:", probs)
    print("Scale 4.0 Real score at index 1:", probs[0, 1])
